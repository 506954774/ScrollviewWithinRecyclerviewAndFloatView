...
public class MyDispatchLinearLayout extends LinearLayout {
    ...
    public MyDispatchLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyDispatchLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
